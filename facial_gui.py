    ...
    while True:
        ...
        if eva is True:
            ...
            try:
                ...
                cv2.putText(frame, 'Face Detected.', (10, int(1 / 16 * height)), font, .4, (255, 255, 255), 1, cv2.CV_AA)
                ...
                font = cv2.FONT_HERSHEY_SIMPLEX
                cv2.putText(frame, 'No Face Detected.', (10, int(1 / 16 * height)), font, .4, (255, 255, 255), 1,
                            cv2.CV_AA)
        else:
            continue
